...
import { ArrowRight, Sparkles, Users, Target, Lightbulb, Rocket, Award, Trophy, Handshake, BookOpen, Clapperboard, Mic, Monitor, Megaphone, FileCheck, Loader2, Building2, TrendingUp, Flag } from 'lucide-react';
...
const departments = [
  ...
  { name: 'Branding Department', icon: TrendingUp },
  { name: 'Founders League', icon: Rocket },
];
